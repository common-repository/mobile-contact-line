...
function yydev_mobile_line_html_output($output_code) {
...
function yydev_mobile_line_show_error_message($error_message, $display_inline = "") {
...
} // function yydev_mobile_line_show_error_message($error) {
...
function yydev_mobile_line_checkbox_isset($post_value) {
...
} // function yydev_mobile_line_checkbox_isset($error) {

// ================================================
// Echoing Message if it's exists 
// ================================================

function yydev_mobile_line_echo_success_message_if_exists($success) {
...
function yydev_mobile_line_echo_error_message_if_exists($error) {

    if(isset($error) && !empty($error) ) {
        echo "<div class='error-messsage'><b>Error:</b> " .  $error . " </div>";
    } // if(isset($_GET['error-message'])) {

} // function yydev_mobile_line_echo_error_message_if_exists() {

// ================================================
// Echoing Message if it's exists 
// ================================================

function yydev_mobile_line_find_page_id() {
...
function yydev_mobile_line_redirections_page($link) {
	header("Location: {$link}");
	exit;
} // function yydev_mobile_line_redirections_page($path) {
